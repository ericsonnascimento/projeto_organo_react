...
const Form = () => {
    ...
    //required={true}: obrigamos que os campos sejam obrigatórios, utilizamos a validação do próprio HTML5 nos componentes "FieldText" e "DropdownList" nos seu respectivos "index.js".
    return (
        <section className='form'>
            <form onSubmit={onSave}>
                <h2>Preencha os dados para criar o card do pet</h2>
                <FieldText required={true} label="Nome" placeholder="Digite o nome do PET" />
                <FieldText required={true} label="Raça" placeholder="Digite a raça do PET" />
                <FieldText label="Imagem" placeholder="Digite o endereço da imagem do seu PET" />
                <DropdownList required={true} label="Raças" itens={racas}/>
